...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 331989917, ; hash 0x13c9c39d, from name: aot-WatchFlowers.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 867267336, ; hash 0x33b17308, from name: WatchFlowers.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WatchFlowers.dll.so
		ptr null; void* handle (0x0)
	}, ; 94
	...
	%struct.DSOCacheEntry {
		i64 1555129083, ; hash 0x5cb162fb, from name: aot-WatchFlowers
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WatchFlowers.dll.so
		ptr null; void* handle (0x0)
	}, ; 172
	...
	%struct.DSOCacheEntry {
		i64 2365352724, ; hash 0x8cfc6b14, from name: libaot-WatchFlowers
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WatchFlowers.dll.so
		ptr null; void* handle (0x0)
	}, ; 267
	...
	%struct.DSOCacheEntry {
		i64 3063905442, ; hash 0xb69f7ca2, from name: libaot-WatchFlowers.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WatchFlowers.dll.so
		ptr null; void* handle (0x0)
	}, ; 366
	...
	%struct.DSOCacheEntry {
		i64 3480863584, ; hash 0xcf79c360, from name: WatchFlowers
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WatchFlowers.dll.so
		ptr null; void* handle (0x0)
	}, ; 406
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [112 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
